...
def run_fallback_checks() -> dict[str, Any]:
    ...
    source_files = [
        ...
        Path("21_run_classification_macos-ui.sh"),
        Path("16_fetch_teller_api_data.py"),
    ]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-json",
        default=".security-reports/teller-api-drift.json",
        help="Path for JSON report output.",
    )
    parser.add_argument(
        "--output-text",
        default=".security-reports/teller-api-drift.txt",
