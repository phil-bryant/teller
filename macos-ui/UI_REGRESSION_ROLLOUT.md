...
- **Gate 2 (snapshot lane)**: `./05_run_macos_ui_regression_tests.sh` with `RUN_XCUITESTS=false`.
- **Gate 3 (full UI lane)**: `./05_run_macos_ui_regression_tests.sh` with defaults to include XCUITest smoke coverage.
