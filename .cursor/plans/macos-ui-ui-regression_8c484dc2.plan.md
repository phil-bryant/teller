...
## Current Baseline
- The app is a Swift Package executable with a single test target and no UI/snapshot test infrastructure in [`/Users/phil/local/src/teller/macos-ui/Package.swift`](/Users/phil/local/src/teller/macos-ui/Package.swift).
- UI is concentrated in SwiftUI views under [`/Users/phil/local/src/teller/macos-ui/Sources/TransactionClassifier/ContentView.swift`](/Users/phil/local/src/teller/macos-ui/Sources/TransactionClassifier/ContentView.swift), backed by `ClassificationViewModel`.
- Existing verification is script-driven (`swift test`) via [`/Users/phil/local/src/teller/04_run_unit_tests.sh`](/Users/phil/local/src/teller/04_run_unit_tests.sh), with no UI automation lane.
...
- Add a snapshot framework dependency to [`/Users/phil/local/src/teller/macos-ui/Package.swift`](/Users/phil/local/src/teller/macos-ui/Package.swift) (e.g., Point-Free `SnapshotTesting`) and create a dedicated snapshot test target.
- Introduce test fixtures/builders that construct `ContentView` with predictable in-memory state (no live API/network).
- Add accessibility identifiers in [`/Users/phil/local/src/teller/macos-ui/Sources/TransactionClassifier/ContentView.swift`](/Users/phil/local/src/teller/macos-ui/Sources/TransactionClassifier/ContentView.swift) for stable targeting and future UI tests.
...
- Wire script into repo verification docs at [`/Users/phil/local/src/teller/macos-ui/README.md`](/Users/phil/local/src/teller/macos-ui/README.md) and [`/Users/phil/local/src/teller/README.md`](/Users/phil/local/src/teller/README.md).
- Optionally call this script from [`/Users/phil/local/src/teller/04_run_unit_tests.sh`](/Users/phil/local/src/teller/04_run_unit_tests.sh) behind a flag (e.g., `RUN_MACOS_UI_REGRESSION_TESTS=true`) to keep local defaults fast.
