...
class TellerAPIClient:
    ...
    def _repair_enrollment(self) -> bool:
        ...
        if enrollment_id:
            try:
                launcher = Path(__file__).resolve().parent / "21_run_classification_macos-ui.sh"
...
def main():
    ...
    try:
        ...
        if exc.code.startswith("enrollment.disconnected"):
            print("Auto-repair failed. Run ./21_run_classification_macos-ui.sh and use the Connect tab to repair.")
        sys.exit(1)
