...
class TellerObject: ## https://teller.io/docs/api
    ...
    def __post_init__(self):
        ...
        log.debug("TellerObject.__post_init__", class_name=self.__class__.__name__, api_data=self._api_data, mapped_api_data=self.mapped_api_data())
        for key, value in self.mapped_api_data().items():
