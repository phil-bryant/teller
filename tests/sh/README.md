...
- `09_configure_teller_io.bats` -> `10_configure_teller_io.sh`
  - Requirement IDs: `R005`, `R010`, `R015`, `R020`, `R025`, `R035`, `R040`
- `10_run_teller-connect-ui.bats` -> `11_run_teller-connect-ui.sh`
...
- `14_run_transaction_classification_macos-ui.bats` -> `15_run_transaction_classification_macos-ui.sh`
