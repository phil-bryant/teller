...
# Requirement test-case tags for requirements/16_verify_classification_persistence-requirements.md
...
# Traceability numbered tags for requirements/16_verify_classification_persistence-requirements.md
...
EOF
  chmod +x "${STUB_BIN}/curl"
  write_psql16
  run env CLASSIFICATION_PERSISTENCE_START_API=false TELLER_DB_PASSWORD=pw TXN_ID=txn1 CATEGORY_ID=7 zsh "${FIXTURE_ROOT}/16_verify_classification_persistence.sh" --require-env-ids
  [ "$status" -ne 0 ]
  [[ "$output" == *"❌ FAIL:"* ]]
