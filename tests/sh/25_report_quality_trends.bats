...
setup() {
  setup_shell_test
  create_repo_fixture
  copy_script_to_fixture "25_report_quality_trends.sh"
...
@test "fails when trend file is missing" {
  run bash "${FIXTURE_ROOT}/25_report_quality_trends.sh"
  [ "$status" -ne 0 ]
...
{"latest_run_started_at":"2026-05-26T00:00:00+00:00","latest_score":9.63,"rolling_20_runs":{"score_avg":9.42,"wall_p50_seconds":128.2,"wall_p95_seconds":149.8},"rolling_14d":{"score_avg":9.5,"pass_reliability":0.97},"performance_slo":{"warn":false,"fail":false}}
JSON
