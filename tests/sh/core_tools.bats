...
@test "core_tools mapped sources carry scoped traceability tags" {
  ...
  for rel in \
    "src/core/tools/oracle_runner.cpp" \
    "src/core/tools/teller_backfill.cpp" \
    "src/core/tools/teller_fetch.cpp"
  do
