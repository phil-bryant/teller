...
class TellerApiClientRequestTimeoutTests(unittest.TestCase):
    ...
    def test_repair_enrollment_raises_manual_repair_when_interactive(self) -> None:
        #R010: UI auto-launch removed during the classy extraction; reconnect is manual via the
        #R010: classy macOS Connect UI, so a disconnected enrollment always fails fast.
        class _FakeTTY:
            @staticmethod
            def isatty():
                return True
