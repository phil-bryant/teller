# Transaction Reclassification API Requirements

## Scope

Applies to `09_transaction_reclassification_api.py`.
...
R005  Statement: Start uvicorn with the teller reclassification ASGI app.
...
- 2026-04-19: Initial reverse-engineered requirements for `09_transaction_reclassification_api.py`.
