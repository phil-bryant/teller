...
Applies to `05_verify_deploy_database.sh`.
...
Design: Check for required roles/schema/core relations deployed by `04_deploy_database.sh` and report missing objects.
Tests:
...
- 2026-04-22: Initial requirements for `05_verify_deploy_database.sh`.
