...
Applies to `21_classification_persistence_verification_test.sh`.
...
- 2026-04-19: Initial reverse-engineered requirements for `21_classification_persistence_verification_test.sh`.
