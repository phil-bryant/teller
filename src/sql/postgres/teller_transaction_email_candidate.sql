CREATE TABLE IF NOT EXISTS matchy.transaction_email_candidate (
    candidate_id BIGSERIAL PRIMARY KEY,
    match_run_id BIGINT NOT NULL REFERENCES matchy.transaction_email_match_run(match_run_id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_transaction_email_candidate_transaction_id
    ON matchy.transaction_email_candidate(transaction_id);

CREATE INDEX IF NOT EXISTS idx_transaction_email_candidate_message_id
    ON matchy.transaction_email_candidate(email_message_id);

COMMENT ON TABLE matchy.transaction_email_candidate IS 'Candidate emails generated by matchy for a specific run';
